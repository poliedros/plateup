    ...
    <Container>
      <div className="flex flex-col items-end text-right mt-24">
        <div
          ...
          style={{
            clipPath:
              "polygon(50% 0%, 50% 0%, 100% 15%, 100% 85%, 50% 100%, 0% 85%, 0% 15%)", //polygon(25% 5%, 75% 5%, 100% 50%, 75% 95%, 25% 95%, 0% 50%)
          }}
        ></div>
        <div
        ...
        <div className="relative z-1 flex flex-col items-end">
          ...
          >
            ...
            {/* <Link href="/profile" className="font-[Hurricane]"> */}
      ...
      <div className="relative z-1 text-white">
        ...
        <h5 className="font-['DM_Serif_Text'] flex items-start">
          ...
          {/* <span className="font-[Hurricane] text-2xl text-right">
          – Andy Rooney
        </span> */}
        </h5>
